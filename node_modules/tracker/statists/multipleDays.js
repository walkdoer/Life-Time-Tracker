...
var overviewPerspective = require('./perspectives/multipleDays.overview');
    ...
    perspectives.forEach(function (key) {
        ...
        try {
            ...
            if (perspective === undefined) {
                perspective = require('./perspectives/multipleDays.' + perspectiveName);
