...
exports.dispose = function(options, dayStats) {
    var statResult = {},
        perspectives;

    statResult = overviewPerspective.focus(options, {days: dayStats});
    ...
    perspectives.forEach(function (key) {
        ...
        if (perspective) {
            ...
            statResult[name] = perspective.focus(options, statResult);
        }
    });
...
exports.disposeOld = function(options, scanResult) {
    var statResult = {},
        perspectives;
