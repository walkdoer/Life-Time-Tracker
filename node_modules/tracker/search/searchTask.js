    ...
    query.exec(function (err, tasks) {
        ...
        tasks.forEach(function (task) {
            task.children = task.children.filter(function (childTask) {
                if (taskStatus === 'doing') {
                    return childTask.progress > 0 && childTask.progress < 100;
                } else if (taskStatus === 'done') {
                    return childTask.progress === 100;
                } else {
                    return true;
                }
            }).sort(function (a, b) {
...
function getQueryConditions(options) {
    var conditions = [{parent: options.parent || { $type: 10 }}],
        timeCondition = [];
...
/*        timeCondition.push({
    ...
    if (timeCondition) {
        conditions = conditions.concat(timeCondition);
    }
