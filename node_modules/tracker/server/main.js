...
app.post('/importLogContent', function (req, res) {
    ...
    Util.writeLogFile(body.date, body.logContent)
    .then(function () {
        Importer.importLogContent(body.date, body.logContent);
    }).then(function () {
        res.status(200).send({success: true});
    }).catch(function (err) {
        res.status(507).send({success: false, err: err});
...
app.get('/logContents/:date', function (req, res) {
    ...
    Util.readLogFiles(date).then(function (result) {
        res.status(200).send(result);
    }).catch(function (err) {
...
app.post('/logContents/:date', function (req, res) {
    ...
    Util.writeLogFile(date, data.content).then(function (result) {
        res.status(200).send({success: true});
    }).catch(function (err) {
