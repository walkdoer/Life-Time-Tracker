    ...
    Q.allSettled(promises).then(function () {
        ...
        importVersion(version, {
            ...
            importTask(log.task, {
                ...
                if (log.task && !log.subTask) {
                    taskProgress = log.task.progress;
                    //console.log('###### update task progress:' + log.task.progress);
                }
                ...
                if (log.subTask) {
                    subTaskProgress = log.subTask.progress;
                }
                saveLog({
                    project: projectId,
...
function importProject(project, attrs) {
    ...
    Project.findOne(queryCondition, function (err, result) {
        ...
        if (!result) {
            ...
            var diffLastActiveTime = new Moment(attrs.end).diff(result.lastActiveTime);
            //update progress
