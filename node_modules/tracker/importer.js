    ...
    if (!taskObj) {
        ...
        Task.findOne(condition, function (err, task) {
            ...
            if (task) {
                ...
                var diffCreateTime = new Moment(createTime).diff(version.createTime);
                if (diffCreateTime < 0) {
                    version.createTime = new Moment(createTime).toDate();
                    console.log('update createdTime ' + createTime);
